<template>
  <div class="Contact">
        ...
        <p class="space-text page-width">If you have any question or suggestion, just say hi trough this awesome contact form. I will reply ASAP. Or not.</p>
        ...
        <form @submit="(e) => submitForm(e)" class="page-width">
            <div class="field">
                ...
                <p v-if='errName' class="err-msg">How can I reply to you if you don't tell me your name?</p>
            </div>
            ...
            <div class="field">
                ...
                <textarea v-model='msg' rows="3" class="garamond text-medium" name="message" type="text" />
                <p v-if='errMsg' class="err-msg">Write a bit more, so I can know what you want.</p>
            </div>

            <div class="submit-container">
                <input class="btn negative oswald text-large submit-btn" type="submit" value="Send Message">
            </div>
        </form>
  </div>
</template>
